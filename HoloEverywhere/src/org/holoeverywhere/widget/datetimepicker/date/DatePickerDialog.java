...
public class DatePickerDialog extends DialogFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getActivity().getPackageManager().checkPermission(Manifest.permission.VIBRATE, getActivity().getPackageName()) == PackageManager.PERMISSION_GRANTED) {
    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                ObjectAnimator pulseAnimator = DateTimePickerUtils.getPulseAnimator(mMonthAndDayView, 0.9f,
                        1.05f);
                if (mDelayAnimation) {
                ...
                DateTimePickerUtils.tryAccessibilityAnnounce(mAnimator, mSelectDay);
                break;
            case YEAR_VIEW:
                pulseAnimator = DateTimePickerUtils.getPulseAnimator(mYearView, 0.85f, 1.1f);
                if (mDelayAnimation) {
                    pulseAnimator.setStartDelay(ANIMATION_DELAY);
                    mDelayAnimation = false;
                }
                ...
                DateTimePickerUtils.tryAccessibilityAnnounce(mAnimator, mSelectYear);
                break;
        }
    }
    ...
    private void updateDisplay(boolean announce) {
        ...
        if (announce) {
            ...
            DateTimePickerUtils.tryAccessibilityAnnounce(mAnimator, fullDateText);
        }
    }
    ...
    public void setDate(int year, int month, int day) {
        ...
        mCalendar.set(Calendar.MONTH, month);
        mCalendar.set(Calendar.DAY_OF_MONTH, day);
        if (mDayPickerView != null && mYearPickerView != null) {
            updatePickers();
            updateDisplay(true);
        }
    }
