...
import org.holoeverywhere.widget.datetimepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    private void updateAmPmDisplay(int amOrPm) {
        if (amOrPm == AM) {
            ...
            DateTimePickerUtils.tryAccessibilityAnnounce(mTimePicker, mAmText);
        } else if (amOrPm == PM) {
            mAmPmTextView.setText(mPmText);
            DateTimePickerUtils.tryAccessibilityAnnounce(mTimePicker, mPmText);
        } else {
            mAmPmTextView.setText(mDoublePlaceholderText);
        }
    }

    public RadialPickerLayout getRadialPickerLayout() {
        return mTimePicker;
    }
    ...
    public void onValueSelected(int pickerIndex, int newValue, boolean autoAdvance) {
        if (pickerIndex == HOUR_INDEX) {
            ...
            DateTimePickerUtils.tryAccessibilityAnnounce(mTimePicker, announcement);
    ...
    private void setHour(int value, boolean announce) {
        ...
        if (announce) {
            DateTimePickerUtils.tryAccessibilityAnnounce(mTimePicker, text);
        }
    }
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        DateTimePickerUtils.tryAccessibilityAnnounce(mTimePicker, String.format("%d", val));
    ...
    public void setTime(int hours, int minute) {
        if (mTimePicker != null) {
            mTimePicker.setTime(hours, minute);
            updateDisplay(true);
        } else {
