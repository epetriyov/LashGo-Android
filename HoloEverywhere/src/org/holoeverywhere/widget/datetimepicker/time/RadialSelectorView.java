...
public class RadialSelectorView extends View {
    ...
    public RadialSelectorView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaint.setColor(a.getColor(R.styleable.DateTimePicker_timePickerSelectorColor, 0));
        a.recycle();
    }
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        if (hasInnerCircle) {
            mInnerNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(R.string.time_numbers_radius_multiplier_inner));
            mOuterNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(R.string.time_numbers_radius_multiplier_outer));
        } else {
            mNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(R.string.time_time_numbers_radius_multiplier_normal));
        }
        mSelectionRadiusMultiplier =
                Float.parseFloat(res.getString(R.string.time_selection_radius_multiplier));
